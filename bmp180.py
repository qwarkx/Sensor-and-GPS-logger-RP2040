...
class BMP180():
    ...
    # init
    def __init__(self, interface = 0, scl=17, sda=16, frq=400000, baseline=101325.0, oversample=3):

        # create i2c obect
        _bmp_addr = self._bmp_addr
        self._bmp_i2c = machine.I2C(id = interface,
                                    scl=Pin(scl),
                                    sda=Pin(sda),
                                    freq=frq)
...
'''
print('Start BARO configuration')
...
while True:
    ...
    try:
        ...
        print('Temperature:  ' + str(temperature) + '    Presure: ' + str(presure) + '   Altitude: ' + str(alt))
